...
function Join() {
  return (
    <section id="joinClub" className="bg-[#F8FCFF] px-5 py-16 md:px-10 md:py-20 xl:px-20">
      <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
        ...
        <div className="grid gap-4 sm:grid-cols-3 lg:grid-cols-1">
          {benefits.map(({ icon: Icon, title, description }) => (
            <article
              key={title}
              className="rounded-2xl border border-blue-100 bg-white p-5 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:border-blue-200 hover:shadow-md"
            >
