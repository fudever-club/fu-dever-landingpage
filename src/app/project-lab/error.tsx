...
// never as a misleading empty board.
export default function Error({ reset }: { reset: () => void }) {
  return (
    <div className="min-h-screen bg-[#F8FCFF] flex items-center justify-center px-5 py-16">
      <div
        role="alert"
        className="max-w-lg w-full rounded-3xl border border-dashed border-rose-200 bg-white p-10 text-center space-y-3 shadow-xs"
      >
        <p className="text-base font-bold text-rose-600">Không thể tải Project Lab.</p>
